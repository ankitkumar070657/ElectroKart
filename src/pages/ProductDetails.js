  ...
  if (isSingleLoading) {
    return (
      <div>
        ...
        <div class="border border-gray-300 shadow rounded-md p-4 max-w-sm w-full mx-auto md:max-w-2xl lg:max-w-4xl mt-4">
        ...
        <div class="hidden sm:block border border-gray-300 shadow rounded-md p-4 max-w-sm w-full mx-auto md:max-w-2xl lg:max-w-4xl mt-4">
        <div class="animate-pulse flex space-x-4">
        <div class="rounded-full bg-gray-400 h-12 w-12"></div>
        <div class="flex-1 space-y-4 py-1">
        <div class="h-4 bg-gray-400 rounded w-3/4"></div>
